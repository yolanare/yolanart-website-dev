...
const projectsDataSample = {
    ...
    "TEMPLATE" : {
        ...
        date : "YYYY.MM",
        category : "artworks|render|motion|brandings|posters|web|other",
        context: "personal|fun|order|school|sc|ppm|retrosaturn|pti",
        filter: "experiment|photo|illustration|3D|motion|type|poster|logo|vector|layout|ad",
    ...
    "COMMENTS" : {
        ...
        category : "artworks|render|motion|brandings|posters|web|other", // CAN BE: "artworks" | "brandings|web"]
        context: "personal|fun|order|school|retrosaturn|pti|sc", // CAN BE: "fun" | "fun|school"]
        filter: "experiment|photo|illustration|3D|motion|type|poster|logo|vector|layout|ad", // CAN BE: "experiment" | "experiment|motion"]
...
// POSTERS
    "pdf_apc_hpi" : {
        ...
        category : "posters",
        context: "order",
        filter: "poster|vector|layout|ad"
    },
    "pdf_apc_wvhp" : {
        type : "g_pdf", interact : "off",
...
const categoriesData = {
    ...
    "posters" : {
        title: "POSTERS",
        subtitle: "Posters, sometimes printed",
